...
$quadrant=-1;
	...
	if (in_array($gridCounter, $nullgrid)) $found = 0;
...
#echo "\n$longitude :: $latitude at Grid $gridCounter $quadrant\nNW corner = $lonCounter  $latCounter\n";
...
$defaultVal=strtoupper(trim(preg_replace("/ /", "_", $defaultVal)));
	...
	$output .= "	<option value=\"$sectional\" id=\"$sectional\" $SELECTED>$displayName</option>\n";
	}
