...
$tmp=`$cmd`;
echo $coordinates[$grid]['Abbrev'] . "	chart: " . $coordinates[$grid]['endGrid'] . "	Calc: " . $gridCounter . "	Start: " . $coordinates[$grid]['startGrid'] ; 
if ($coordinates[$grid]['endGrid'] == $gridCounter) echo "	OK";
echo "\n";
}
